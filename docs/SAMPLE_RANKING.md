...
- 版: v2(第245便・2026-09-06 — 第230便 v1 の更新: 廃止 6 本を削除し、状態変化系 4 本を収録)。目的: **カタログ整理の指針**(外部レビュー2系の裁定統合)。
...
## ランク表(97サンプル — 第245便でサンプル整理: ☀️🌻🍊🍂🌋⛲ の 6 本を廃止・⚪🔵🎆 を追加)
...
| supernovaCore | S | 速い小コアが殻を割り、回転 E を支払って吹き飛ばす — 帳簿が閉じる用量反応(第245便: 分割を併載) |
| envelopeShedDFM | S | 「殻が割れて出る」機構そのもの — 4帳簿が発火の1步で閉じる(第245便: n 32 で密に) |
| whiteDwarfDFM | A | 赤色巨星→白色矮星の道。**1回では「コアだけ」にならない**限界を明示(第245便) |
| nsRemnantDFM | A | 前駆星→中性子星の道。**時計が爆発を越えて残骸に残る**のが見どころ(第245便) |
