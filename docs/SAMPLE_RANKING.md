...
- 版: v6(第254便a・2026-09-10 — 第46報「空間メッシュ本体」: 🪟 spaceMeshBinaryToy〔メッシュの重力は既にある重力〕を「空間と時間」へ追加)。
...
| spaceMeshBinaryToy | A | 輸送された物質線が公転に随伴するのが見える。ただし**主張は否定側**(メッシュの重力は既にある重力で、繋いでも何も変わらない)なので、A/B で「変わらないこと」を読ませる説明が要る |
