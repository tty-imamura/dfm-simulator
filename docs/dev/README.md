...
このフォルダには、アプリの利用者・理論の読者には不要な**開発プロセス資料**を置く
(2026-07-21 に docs/ 直下から移動)。

| ファイル | 内容 |
|---|---|
| [MODEL_ROUTING.md](MODEL_ROUTING.md) | 開発時/実行時のモデル割当・品質基準・コスト見積り(v1.x 改訂履歴を含む) |
| [HANDOFF_IMPLEMENTATION.md](HANDOFF_IMPLEMENTATION.md) | 設計→実装の実行指示書(改修時はこれを添えて下位モデルに委譲可) |
...
ライセンスは docs/LICENSE(CC BY 4.0)が本フォルダにも適用される。
