...
const REGEN_SCOPE = {"presets":["saturn","shapeToyArmCore","shapeToyCluster","shapeToyClusterCore","shapeToyDiskCore"],"roots":["$","HP.allPresets","HP.currentPreset","HP.dfmCoreFieldStep","HP.sim","HP.validatePreset","T","applyQLock","ch","coreFieldBasis","ctx","isNum","validatePreset"],"core":true,"consts":[],"complete":true};
