...
// ⚠️第71便での訂正(2026-08-04): E5/E5b/E5c の「力学選別(比1.25)」は**終状態の符号付き
//   spin>1 で群を再分類したことによるアーチファクト**と判明(正追跡では選別なし 0.96)。
//   本スクリプトは実験履歴として不変に残す — 訂正の正本は tests/exp-4-71.mjs(F4)と
//   CHANGELOG v1.36-b8。E5 の meanR(hot) が走行後に同じ述語で再分類している点が原因
