...
const REGEN_SCOPE = {"presets":["shapeToyArm","shapeToyCluster","shapeToyDisk"],"roots":["$","HP.allPresets","HP.currentPreset","HP.shapeToyDisc","HP.sim","HP.validatePreset","T","applyQLock","ch","ctx","isNum","shapeToyDisc","validatePreset"],"core":true,"consts":[],"complete":true};
