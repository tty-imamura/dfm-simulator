...
// ★結論(2026-08-04 実測): 第70便の「選別」は**分類アーチファクト**だった(F4 で定量化 —
//   正追跡 0.96 ⇔ E5 方式再分類 1.2498 で第70便値を厳密再現)。実在するのは③残余トルクによる
//   全星スピンの逆行汲み下げ(中心ほど速い)で、集団の移動・選別は起きない。
// - 元の問い: 「高温星=ディスク残留・低温星=中心沈降(比1.25)」は E6′ のどの項が運ぶのか。
