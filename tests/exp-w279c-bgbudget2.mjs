...
const REGEN_SCOPE = {"presets":["earthMoonRealKF1","galaxy","plutoCharonReal","psrDoubleAB"],"roots":["$","HP.allPresets","HP.sim","HP.validatePreset","T","applyQLock","ch","ctx","dfmBlendComplexMoments","dfmComplexMomentsOf","dfmField","dfmGeoToyStep","dfmLocalMeshField","dfmMeshVelocityRHS","dfmMeshVelocityStep","isNum","validateBackgroundTidal","validatePreset"],"core":true,"consts":[],"complete":true};
