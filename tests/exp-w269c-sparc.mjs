...
const REGEN_SCOPE = {"presets":["galaxy","ngc3198","ngc3198DFM"],"roots":["$","HP.allPresets","HP.sim","HP.validatePreset","T","applyQLock","ch","clamp","ctx","isNum","sim","validatePreset"],"core":true,"consts":[],"complete":true};
