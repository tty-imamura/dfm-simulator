...
% Title: option (a) of the brief; final title is an author decision
%        (Sec. 7 of the brief).
...
\usepackage{hyperref}
\hypersetup{
  pdftitle={The Box Universe: Probe-Dependent Expansion in a Relational
    Toy Model},
  pdfsubject={Educational toy model; expansion; Hubble tension analogy}}

\begin{document}

\title{The Box Universe: Probe-Dependent Expansion in a Relational Toy Model}

\author{Tetsuya Imamura}
\affiliation{Independent researcher, Japan}

\date{2026-07-29 (draft v0.1)}
...
a ratio of $0.923$.
In the box universe, choosing the single calibration $D/K_t=0.92$
makes the probe ratio at $a=2$
\begin{equation}
