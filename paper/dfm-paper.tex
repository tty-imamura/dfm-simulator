...
% CURRENT VERSION: v0.11 (2026-08-22, wave 161).
...
% only notation canonicalization (K_t written as kappa), the extended
...
%       time, together with the extended subtitle.
...
\hypersetup{
  pdftitle={Determinacy-Field Mechanics: A Machian Toy Universe with
    Tunable Frame Dragging, Inverse-Square Gravity, and
    Spin-as-Heat Analogies: Reproducing the GPS Clock Offset,
    Solar-Limb Deflection and Shapiro Delay as Consequences of One
...
\title{\texorpdfstring{Determinacy-Field Mechanics: A Machian Toy
Universe with Tunable Frame Dragging, Inverse-Square Gravity, and
Spin-as-Heat Analogies:\\
Reproducing the GPS Clock Offset, Solar-Limb Deflection and Shapiro
Delay as Consequences of One Calibration, Not as Evidence}%
{Determinacy-Field Mechanics: A Machian Toy Universe with Tunable Frame Dragging, Inverse-Square Gravity, and Spin-as-Heat Analogies: Reproducing the GPS Clock Offset, Solar-Limb Deflection and Shapiro Delay as Consequences of One Calibration, Not as Evidence}}
...
\date{July 20, 2026 (v0.9, version of record); revised August 21, 2026
  (v0.10); revised August 22, 2026 (v0.11)}
...
only in notation canonicalization, the extended subtitle, and
typesetting; the revision is re-deposited at submission time.
