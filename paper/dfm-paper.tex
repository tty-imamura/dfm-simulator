...
% VERSION OF RECORD: v0.9 (2026-07-20; wave 143 typesetting/citation
% pass, no claim or number changed).  The single version statement for
% this manuscript is v0.9 -- it is repeated in paper/README.md and
% nowhere else.  The list below is the revision history.
...
The panel labels carry the legacy form of the coefficient,
$K_t = 1/\Kt$ (i.e.\ $K_t = 150$ and $500$).
